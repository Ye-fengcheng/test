    ...
    <div style="line-height: 26px;">
      <el-row>
        <el-col :span="18">
          ...
          &nbsp;&nbsp;
          <el-button size="mini" @click="$util.winOpen('static/useJs/doc/OrderProportionProvince.xlsx?'+$util.getRandom())" type="text">下载模板</el-button>
        </el-col>
  ...
  export default {
    ...
    methods: {
      ...
      treatDatas(datas){
        ...
        thiz.$tupHttp(thiz,'product/importOrderProportionByProvince','POST',{list:arr ,remark:this.remark}).then(res=>{
          thiz.loading = false;
          thiz.fileList = [];
          thiz.remark = '';
          thiz.$notify.success({

<template>
  <div v-loading="loading">
    <div style="line-height: 26px;">
      ...
      &nbsp;&nbsp;
      <el-button size="mini" @click="$util.winOpen('static/useJs/doc/BOConfig.xlsx?'+$util.getRandom())" type="text">下载模板</el-button>    </div>
    <el-table
      :data="tableData"
  ...
  export default {
    ...
    methods: {
      ...
      loadData(isSearch){
        ...
        thiz.$tupHttp(thiz,'inventory/getUpdateBORecordList','POST',thiz.searchForm).then(res=>{

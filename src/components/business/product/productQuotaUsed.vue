  ...
  export default {
    ...
    methods: {
      ...
      downLoad(){        
        ...
        thiz.$tupHttp(thiz,'inventory/exportFmsQuotaDetails','POST',data,{},'',true).then(res=>{
          thiz.loading = false;
          thiz.$notify.success({
            title: '成功提示',
      ...
      loadData(isSearch){
        ...
        thiz.$tupHttp(thiz,'inventory/selectFmsQuotaDetailByPage','POST',thiz.searchForm).then(res=>{

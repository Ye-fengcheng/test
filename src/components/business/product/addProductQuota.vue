<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item :to="{ path: '/frame/product/productQuota'}">产品配额</el-breadcrumb-item>
...
<script>
  import fmsQuotaTable from '@/components/business/product/ass-fms-product-quota-table'
  export default {
    data() {
      return {
    ...
    methods: {
      ...
      commit(){        
        ...
        thiz.$tupHttp(thiz,'inventory/uploadProductQuotaExcel','POST',data).then(res=>{
          thiz.loading = false;
          if(res.body.valid){
            thiz.$notify.success({
              title: '提示',

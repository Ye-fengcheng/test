<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item :to="{ path: url}">开店申请</el-breadcrumb-item>
...
<script>
  export default {
    data() {
      return {
        url:'/frame/customerApprove/customerOpeningApprove',
    ...
    mounted(){
      if(this.type == 'all'){
        this.url = '/frame/customerApprove/allCustomerOpeningApprove'
      }
      this.getInfo();    
      this.getTaskInfo();
      this.loadDictions();  

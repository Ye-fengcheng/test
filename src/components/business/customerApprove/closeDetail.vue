<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item :to="{ path:url}">结业申请</el-breadcrumb-item>
...
<script>
  export default {
    data() {
      return {
        url:'/frame/customerApprove/customerCloseApprove',
    ...
    mounted(){
      if(this.type == 'all'){
        this.url = '/frame/customerApprove/allCustomerCloseApprove'
      }
      this.getInfo();    
      this.loadDictions();  
    }

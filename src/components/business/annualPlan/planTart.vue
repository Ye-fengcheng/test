  ...
  <div>
    ...
    <el-table
      ...
      <el-table-column
       ...
       <el-table-column
        ...
        <template slot-scope="scope"> 
          {{scope.row.hotsaleProductAmtPro ? $util.formatThousand(scope.row.hotsaleProductAmtPro*100,0)+'%':''}}
        </template>
      </el-table-column>
      <el-table-column
        prop="pDiscountvalue"
        ...
        width="100">
        <template slot-scope="scope"> 
          {{$util.formatThousand(scope.row.pDiscountvalue,0)}}%
        </template>
      </el-table-column>
      <el-table-column
        prop="saleAmtTar"
      ...
      <el-table-column
        ...
        width="150">
        <template slot-scope="scope"> 
          {{scope.row.orderGrowthRate ? $util.formatThousand(scope.row.orderGrowthRate*100,0)+'%':''}}
        </template>
      </el-table-column>
      <el-table-column
        prop="updateTime"

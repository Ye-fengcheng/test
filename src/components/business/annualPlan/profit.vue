    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope"> 
          {{scope.row.actAmt ? $util.formatThousandNotFixed(scope.row.actAmt,2):''}}
        </template>
      </el-table-column>
      <el-table-column
        prop="stockAmt"
        ...
        width="150">
        <template slot-scope="scope"> 
          {{scope.row.stockAmt ? $util.formatThousandNotFixed(scope.row.stockAmt,2):''}}
        </template>
      </el-table-column>
      <el-table-column
        prop="vip"
      ...
      <el-table-column
        prop="jacketedkettleSaleQty2"
        width="120"
        label="5.7L多用锅销售数量">
      </el-table-column> 
      <el-table-column
        prop="jacketedkettleStockQty2"
        width="120"
        label="5.7L多用锅库存数量">
      </el-table-column>
      <el-table-column
      ...
      <el-table-column
        ...
        width="100">
        <template slot-scope="scope"> 
          {{$util.formatThousandNotFixed(scope.row.netProfit,2)}}
        </template>
      </el-table-column>
      <el-table-column
        prop="netProfitRate"
        ...
        width="100">
        <template slot-scope="scope"> 
          {{scope.row.netProfitRate ? $util.formatThousandNotFixed(scope.row.netProfitRate*100,0)+'%':''}}
        </template>
      </el-table-column>
      <el-table-column
        prop="stockDay"

<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>添加满赠/KIT-单品</el-breadcrumb-item>
    </el-breadcrumb>
    <br/>
    <div style="width:100%">
      <div style="float:left;width:100px">
        <div class="transition-box">满赠</div>
      </div>
      <div style="margin-left:100px">
        <el-form :model="comForm" :rules="comRules" ref="comForm" label-width="160px">
          ...
          <div class="grid-content bg-purple">
            <h5>条件产品：</h5>
            <tup-product-select v-model="comForm.promotionRule.products" type="kit" :first="promotionThemeType==0"></tup-product-select>
          </div>      

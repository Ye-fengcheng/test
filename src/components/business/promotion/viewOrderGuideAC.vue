<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>修改买赠</el-breadcrumb-item>
    </el-breadcrumb>
    <br/>
    <div style="width:100%">
      ...
      <div style="margin-left:100px">
        <el-form :model="comForm" disabled :rules="comRules" ref="comForm" label-width="160px">
          ...
          <div class="loopDiv" v-for="(item, index) in comForm.promotionRule.rules" :key="index">
            ...
            <el-form-item label="" label-width="50px" style="width: 80%;" prop="num">
              <el-radio  v-model="item.byMoney" :label="0">购买满(数量)</el-radio >
              <el-input-number size="mini" :disabled="item.byMoney == 1" :min="0" v-model="item.num"  placeholder="多少件"></el-input-number>(大单位)
            </el-form-item>

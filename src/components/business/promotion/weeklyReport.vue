  ...
  <div>
    <el-form  :model="searchForm" label-width="120px" class="demo-form-inline">
      ...
      <el-row :gutter="5">
        <el-col :span="8">
          <el-form-item label="报表状态">
            <el-select v-model="searchForm.condition.reportStatus" size="mini" clearable filterable  placeholder="请选择">
              <el-option
        ...
        <el-col :span="8">          
          <el-form-item label="FS">
            <el-input v-model="searchForm.condition.fs" size="mini" placeholder="FS"></el-input>
          </el-form-item>
        </el-col>        
        <el-col :span="8">
          <el-form-item label="DM">
            <el-input v-model="searchForm.condition.dm" size="mini" placeholder="DM"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="5">
        ...
        <el-col :span="8">          
          <el-form-item label="专卖店类型">
            <el-select v-model="searchForm.condition.storeType" size="mini" clearable filterable  placeholder="请选择">
              <el-option
      ...
      <el-form-item>
        ...
        <el-button type="primary" @click="downLoad" :loading="loading" icon="el-icon-download" size="mini">导出</el-button>
        <el-button icon="el-icon-minus" :disabled="multipleSelection.length==0" size="mini" :loading="loading" @click="rejects" type="danger">批量拒绝</el-button>
    <el-button icon="el-icon-check" :disabled="multipleSelection.length==0" size="mini" :loading="loading" @click="approves" type="primary">批量审批</el-button>
      </el-form-item>
    </el-form>
    ...
    <el-table
      ...
      <el-table-column
        ...
        width="100">
        <template slot-scope="scope">
          <a v-if="scope.row.groupContractUrl" :href="scope.row.groupContractUrl" target="_blank">下载</a>
        </template>
      </el-table-column>      
    </el-table>

<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>批量创建负调整单</el-breadcrumb-item>
    </el-breadcrumb>
    <br/>
    <div>
      <el-form ref="comForm" label-width="160px">
        <div class="grid-content bg-purple">
          <fms-backend-table v-model="comForm.datas" type="TZ" type-name="负调整单" :adjust="0"></fms-backend-table>
        </div> 
      </el-form>
    </div>
  ...
  export default {
    ...
    methods: {
      ...
      commit(){        
        ...
        thiz.$tupHttp(thiz,'order/saveDrafts','POST',{draftList:data,orderType:'TZ',plusOrMinusAdjust:0}).then(res=>{
          thiz.loading = false;
          if(res.body.valid){
            thiz.$notify.success({
              title: '提示',

  ...
  <div>
    <el-form  :model="searchForm" label-width="120px" class="demo-form-inline">
      ...
      <el-form-item>
        ...
        <el-button icon="el-icon-plus" size="mini" @click="gotoUrl('/frame/order/backendOrder/specialOrder')" type="primary">添加</el-button>
        <el-button icon="el-icon-plus" size="mini" @click="gotoUrl('/frame/order/backendOrder/specialOrderImport')" type="primary">导入数据</el-button>
...
<script>
  export default {
    name:'keepAlive-order-backendOrder-specialOrderList',
    data() {
      return {
        multipleSelection:[],
        Dictions:{
        ...
        searchForm:{
          condition:{
            ...
            remark:'',
            createBy:'',
            statusList:[1,5],//（1:已创建，2:处理中，3:已提交，5提交失败）
            orderType:'TS'
          },          
          pagingQuery:{
            pageIndex:1,
    ...
    watch:{
      $route:function(val){
        if(val.path == '/frame/order/backendOrder/specialOrderList'){
          if(this.total > 0){
            //有请求过数据需要重新加载列表
            this.loadData()
          }

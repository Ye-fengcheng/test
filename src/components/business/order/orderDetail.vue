<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item :to="{ path: '/frame/order/returnOrderAndGoods'}">订单退单退货</el-breadcrumb-item>
      <el-breadcrumb-item>订单退单退货处理</el-breadcrumb-item>
    </el-breadcrumb>
    <br/>
    <el-form label-width="120px">
      ...
      <el-row>
        ...
        <el-col :span="12" style="text-align:right"><el-button @click="$router.go(-1)">返回</el-button></el-col>
      </el-row>
    </el-form>
    ...
    <el-tabs v-model="activeName" type="card">
      <el-tab-pane label="产品订单详细" name="zero">
        <el-table
          ...
          <el-table-column
            ...
            width="100">
            <template slot-scope="scope"> 
              {{$util.formatThousand(scope.row.orderUnitPrice/scope.row.orderRatio,2)}}
            </template>
          </el-table-column>
          <el-table-column
            prop="isDiscount"
        ...
        <div class="dialog-footer">          
          <el-button @click="showDialog" :disabled="multipleSelection.length==0" :loading="loading"  type="primary">确定退单/退货</el-button>      
        </div>  
      </el-tab-pane>
      ...
      <!-- <el-tab-pane label="客户退货信息" name="second">
        <div>
          <el-form :model="customerModel" ref="modelForm" label-width="220px">
            <el-row>
              <el-col :span="8">
...
<script>
  export default {
    ...
    methods: {
      ...
      getInfo(){
        let thiz = this;
        thiz.$tupHttp(thiz,'order/returnPageDetail?orderNo='+this.orderNo,'GET').then(res=>{

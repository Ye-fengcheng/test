<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item :to="{ path: '/frame/terminal/otherCustomer'}">其他客户信息</el-breadcrumb-item>
    ...
    <el-row>
      ...
      <el-col :span="6" style="text-align:right"><el-button @click="gotoUrl('/frame/terminal/otherCustomer')">返回</el-button></el-col>
    </el-row>
...
<script>
  export default {
    ...
    methods: {
      toContactHistory(){
        this.gotoUrl('/frame/terminal/otherCustomerContact/'+this.clientId)
      },
      printHT(){

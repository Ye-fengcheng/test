      ...
      <el-row :gutter="5">
        ...
        <el-col :span="8">
          <el-form-item label="客户编号">
            <el-input v-model="searchForm.organId" size="mini" placeholder="客户编号"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
      ...
      <el-row :gutter="5">
        <el-col :span="8">
          <el-form-item label="客户层级">
            <el-select v-model="searchForm.citorganlevel" size="mini" clearable filterable  placeholder="请选择">
              <el-option label="tupperware china" :value="0"></el-option>
              <el-option label="区域" :value="1"></el-option>
              <el-option label="省办" :value="2"></el-option>
              <el-option label="城办" :value="3"></el-option>
...
<script>
  export default {
    ...
    methods: {
      ...
      view(ind,row){
        this.gotoUrl('/frame/terminal/otherCustomerDetail/'+row.pUid+'/zero')
      },
      downLoad(){        
        let thiz = this;
        thiz.loading = true;
      ...
      loadDictions(){
        let thiz = this;
        let params = ["outlet_property","outlet_status","grade_type","outlet_property2","visualize_grade","graduation_reason","msg_source","outlet_show","location","address_source","gender","bop_explain"];

<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item :to="{ path: url}">线下充值审批</el-breadcrumb-item>
      <el-breadcrumb-item>充值详情审核</el-breadcrumb-item>
    </el-breadcrumb>
      ...
      <el-col :span="16">
        <el-form :model="comForm" :rules="comRules" label-position="right" ref="comForm" label-width="120px">
          ...
          <el-form-item label="货款金额" prop="balance">
            <el-input-number :min="0" v-model="balance" :disabled="comForm.auditStatus == '8796113240155'" placeholder="货款金额"></el-input-number>
          </el-form-item>
          <el-form-item label="保证金金额" prop="deposit">
            <el-input-number :min="0" v-model="deposit" :disabled="comForm.auditStatus == '8796113240155'" placeholder="保证金金额"></el-input-number>
          </el-form-item>      
          ...
          <el-form-item label="打款时间" prop="commitTime">
            <el-date-picker type="datetime" :disabled="comForm.auditStatus == '8796113240155'" v-model="commitTime"  placeholder="打款时间"></el-date-picker>
          </el-form-item>      
          ...
          <el-form-item label="款项用途" prop="title">
            <el-select :disabled="comForm.auditStatus == '8796113240155'" v-model="comForm.type" filterable  placeholder="请选择">
          ...
          <el-form-item label="客服处理意见" prop="comment1">
            <el-input :disabled="comForm.auditStatus != '8796113240155'" type="textarea" :row="2" v-model="comForm.comment1"  placeholder=""></el-input>
          </el-form-item> 
          ...
          <el-form-item label="财务处理意见" prop="comment2">
            <el-input :disabled="comForm.auditStatus != '8796113272923'" type="textarea" :row="2" v-model="comForm.comment2"  placeholder=""></el-input>
          </el-form-item> 
          <el-form-item label="最后更新时间" prop="updateTime">
            <el-input disabled="true" v-model="updateTime"  placeholder="最后更新时间"></el-input>
          </el-form-item> 
          <el-form-item label="备注" prop="remark">
            <el-input  type="textarea" :disabled="comForm.auditStatus == '8796113240155'" :row="2" v-model="comForm.remark"  placeholder="备注"></el-input>
          </el-form-item>
        </el-form>
      </el-col>
      <el-col :span="4">&nbsp;</el-col>
    ...
    <div class="dialog-footer">
      ...
      <el-button @click="commit(true)" v-if="comForm.auditStatus == '8796113240155'" :loading="loading"  type="primary">审核通过</el-button> 
      <el-button @click="commit(false)" v-if="comForm.auditStatus == '8796113240155'" :loading="loading"  type="danger">审核不通过</el-button> 

      <el-button @click="financeCommit(true)" v-if="comForm.auditStatus == '8796113272923'" :loading="loading"  type="primary">财务审核通过</el-button> 
      <el-button @click="financeCommit(false)" v-if="comForm.auditStatus == '8796113272923'" :loading="loading"  type="danger">财务审核不通过</el-button>             
    </div>
  ...
  export default {
    data() {
      return {
        ...
        url:'/frame/account/underLineForCs',
        comForm:{
          auditor1:'',
          auditor1Id:'',
          auditor2:'',
    ...
    watch:{
      ...
      'comForm.auditStatus':function(val){
        if(val == '8796113272923'){
          this.url = '/frame/account/underLineForFinance'
        }
        else{
          this.url = '/frame/account/underLineForCs'
        }
      },

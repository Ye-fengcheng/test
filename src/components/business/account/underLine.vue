  ...
  <div>
      ...
      <el-row :gutter="5">
        ...
        <el-col :span="8">
          <el-form-item label="收款银行">
            <el-select v-model="searchForm.bank" clearable filterable size="mini" placeholder="请选择">
      ...
      <el-row :gutter="5">
        <el-col :span="8">
          <el-form-item label="审核状态">
            <el-select v-model="searchForm.status" clearable filterable size="mini" placeholder="请选择">
              <el-option
      ...
      <el-row :gutter="5">
        <el-col :span="8">
          <el-form-item label="付款金额范围">
            <el-input style="width:40%" v-model="searchForm.startNum" size="mini">
            </el-input>
            至
    ...
    <el-table
      ...
      <el-table-column
        ...
        width="80">
        <template slot-scope="scope">
          <el-button @click="viewItem(scope.$index,scope.row)" type="text" size="small">查看详情</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script>
  export default {
    name:'keepAlive-account-underLine',
    data() {
      return {
        loading:false,
        currentPage:1,
    ...
    watch:{
      $route:function(val){
        if(val.path == '/frame/account/underLine'){
    ...
    methods: {
      ...
      viewItem(index, row) {
        this.gotoUrl('/frame/account/underLineDetailView/'+row.id)
      },
      formatter(row, column) {
        ...
        else if(column.property =='createTime' || column.property =='commitTime' || column.property =='auditor1Time'|| column.property =='auditor2Time'){
